...
if __name__ == '__main__':
    ...
    for instance in glob(os.path.join(tsiligirides_hop_dir(), '*.json')):
        ...
        script_filename = os.path.join(launchers_dir, f"launcher_nonlinear_model_{base}.sh")

        with open(script_filename, 'w') as f:
            f.write(get_script_base(output_dir=output_dir, script='run_baron.py', cmdline_args=instance, instance_base=base, timeout='01:30:00') + '\n')
