...
if __name__ == '__main__':
    ...
    for instance_num, instance_file in enumerate(instances):
        ...
        if already_solved(instance=instance, algorithm='nonlinear_model_without_vi'):
            print('\tBaron results cached: skipping.')
        else:
            results = run_nonlinear_baron(instance=instance, add_vi=False, time_limit=3600, concave=False)
